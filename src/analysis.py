...
player_df = summoner.merge(merged_match, left_on="MatchFk", right_on="MatchId")

player_df = player_df.merge(champ, left_on="ChampionFk", right_on="ChampionId")
player_df = player_df.merge(rank, left_on="RankFk", right_on="RankId", how="left")
